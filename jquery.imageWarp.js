...
jQuery.imageWarp={
	dsettings: {
		warpfactor: 1, //default increase factor of enlarged image
	...
	addEffect:function($, $target, options){
		...
		var $clone=$target.clone().css({position:'absolute', left:0, top:0, visibility:'hidden', border:'none', zIndex:1000}).appendTo(document.body)
